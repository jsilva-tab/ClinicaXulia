...
public class PasswordResetService {
    ...
    public void sendPasswordResetEmail(String userEmail) {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            String query = "INSERT INTO password_reset (user_id, pincode, expiration_time) VALUES ((SELECT cpf_cliente FROM tb_clientes WHERE email_cliente = ?), ?, ?) ON DUPLICATE KEY UPDATE pincode = VALUES(pincode), expiration_time = VALUES(expiration_time)";
